...
void main(void)
{
    ...
    if (isalpha (p1))
        if (islower (p1))
        /* La funcion eslower regresa 1 si p1 es una letra minuscula y 0 en caso contrario. La funcion isupper, por otra parte, regresa 1 si p1 es una letra mayuscula y 0 en caso contrario. */
