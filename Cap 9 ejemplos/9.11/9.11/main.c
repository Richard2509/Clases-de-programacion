...
/* Incrementa salarios.
El programa incrementa el salario de los empleados de una empresa, actualiza el archivo correspondiente, su sus ventas son superiores al millon de pesos anuales. */
