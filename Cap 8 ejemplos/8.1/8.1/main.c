...
/* Estructuras-1.
El programa muestra la manera en que se declara una estructura, asi como la forma en que se tiene acceso a los campos de las variables de tipo estructura tanto para asignacion de valores como para lesctura y escritura. */
...
void main(void)
{
    ...
    printf("\nIngrese el matricula del alumno 2: ");
