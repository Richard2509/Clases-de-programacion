...
/* Unionen.
El programa muestra como se declara una union, asi como la forma de acceso a los campos de las variables de tipo union tanto para asignacion de valores como para lectura y escritura. */
