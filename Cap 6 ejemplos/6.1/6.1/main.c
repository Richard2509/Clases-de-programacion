...
/* La funcion Lectura se utiliza para leer un arreglo bidimensional. Observa que solo se debe pasar como un parametro el numero de filas ya que la matriz es cuadrada. */
{
    int I, J;
    for (I=0; I<F; I++)
        for (J=0; J<F; J++)
