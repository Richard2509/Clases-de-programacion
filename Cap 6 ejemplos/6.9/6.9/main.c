...
void main(void)
{
    ...
    do
    {
        printf("Imprime el tamano de la matriz: ");
        scanf("%d", &TAM);
    }
    while (TAM >10 || TAM < 1);
    Lectura(MAT, TAM);
...
/* Esta funcion se utilza tanto para calcular el modulo entre el indice del arreglo unidimensional y 3, como para llamar a las funciones correspondientes para resolver el problema. */
{
    int I;
    for (I=0; I<N; I++)
        switch (I%3)
