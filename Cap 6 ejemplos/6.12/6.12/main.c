...
/* Esta funcion se utiliza para localizar la provincia que tuvo el mayor registro de precipitacion pluvial en los ultimos 10 anos. Escribe ademas el registro
correspondiente. */
