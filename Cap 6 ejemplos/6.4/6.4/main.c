#include <stdio.h>
 ...
 void main(void)
 {
     ...
     while (N > MAX || N < 1);      /* Se verifica que el tama;o del arreglo sea valido. */
 ...
 /* La funcion Simetrico se utiliza para determinar si el arreglo bidimensional cuadrado es simetrico. Si es simetrico regresa 1, en caso contrario, 0.
