...
void main(void)
{
    ...
    /* Se escribe e do-while para verificar que el numero del cual se quiere calcular la productoria sea correcto. */
    do
    {
    ...
    while (NUM >100 || NUM < 1);
    printf("\nLa productotia de %d es: %d", NUM, Productoria(NUM));
}
