#include <stdio.h>
 ...
 /* Esta funcion calcula el maximo comun divisor de los numeros N1 y N2. */
 {
     ...
     while ((N1 % I) || (N2 % I))
        /* El ciclo se mantiene activo mientras (N1 % I) o (N2 % I) sean distintos de cero. Cuando el resultado de la evaluacion sea 0, el ciclo se obtiene ya que se habra encontrado el maximo comun divisor.  */
        I--;
     return I;
 }
