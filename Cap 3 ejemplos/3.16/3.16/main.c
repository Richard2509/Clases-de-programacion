...
/* Calificaciones.
El programa, al recibir un grupo de calificaciones de un alumno, obtiene el promedio de calificaciones de cada un de ellos y, ademas, los alumnos con el mejor y peor promedio.
