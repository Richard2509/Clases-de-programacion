...
/* Esta funcion se utiliza para realizar una busqueda binaria del elemento E en el arreglo unidimencional A de T elementos. si se encuentra el elemento, la funcion regresa la posicion correspondiente. En caso contrario, regresa 0. */
{
